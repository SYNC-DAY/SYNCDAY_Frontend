			...
			<div class="workspace-header container-row underline-gray">
				<div class="container-row header-left">
					...
					<Button
						...
						v-tooltip="'Repository Settings'"></Button>
					<Button
						icon="pi pi-sync"
						text
						@click.stop="showMilestoneSelection = true"
				...
				<div class="container-row header-right">
					...
					<Button
						icon="pi pi-tag"
						@click="showTagDialog = true"></Button>
					<!-- 태그 관리 Dialog -->
					<Dialog
